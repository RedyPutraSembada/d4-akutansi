    ...
    <section class="section">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">Tambah Data Layanan Ijazah & Transkip Nilai</h4>
            </div>

            <div class="card-body">
                <div class="row">
                    <form action="{{ route('store-ijazah-transkip-nilai') }}" method="post">
                        @csrf
                        <div class="col-md-12">
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="deskripsi_tengah" class="form-control @error('deskripsi_tengah') is-invalid @enderror" name=""
                                    id="" cols="30" rows="10">{{ old('deskripsi_tengah') }}</textarea>
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="deskripsi_bawah" class="form-control @error('deskripsi_bawah') is-invalid @enderror" name=""
                                    id="" cols="30" rows="10">{{ old('deskripsi_bawah') }}</textarea>
