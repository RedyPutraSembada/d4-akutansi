    ...
    <section class="section">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">Edit Data Profile Lulusan</h4>
            </div>

            <div class="card-body">
                <div class="row">
                    <form action="{{ route('update-profil-lulusan', $profilLulusan->id) }}" method="post"
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input name="judul_atas" type="text"
                                    ...
                                    value="{{ old('judul_atas', $profilLulusan->judul_atas) }}">
                                @error('judul_atas')
                            ...
                            <div class="form-group">
                                <div class="card shadow-sm p-2 m-0">
                                    @if ($profilLulusan->img)
                                        <img src="{{ asset('storage/' . $profilLulusan->img) }}" class="img-responsive"
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="content" class="form-control @error('content') is-invalid @enderror" name="" id=""
                                    cols="30" rows="10">{{ old('content', $profilLulusan->content) }}</textarea>
                                @error('content')
                                    <p><small class="text-danger">{{ $message }}</small>
                                    @enderror
                                </p>
                            ...
                            <div class="form-group">
                                ...
                                <input name="judul_table_bawah" type="text"
                                    ...
                                    value="{{ old('judul_table_bawah', $profilLulusan->judul_table_bawah) }}">
