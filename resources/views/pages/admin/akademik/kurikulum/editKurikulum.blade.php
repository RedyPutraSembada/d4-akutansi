...
@section('content')
    <section class="section">
        <div class="card">
            ...
            <div class="card-body">
                <div class="row">
                    <form action="{{ route('update-kurikulum', $kurikulum->id) }}" method="post"
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="form-group">
                                <div class="card shadow-sm p-2 m-0">
                                    @if ($kurikulum->img_kurikulum)
                                        <img src="{{ asset('storage/' . $kurikulum->img_kurikulum) }}"
                            ...
                            <div class="form-group">
                                ...
                                <input name="img_kurikulum"
                                    class="form-control @error('img_kurikulum') is-invalid @enderror" type="file"
                                    id="imgInp" multiple>
                                @error('img_kurikulum')
                                    <p><small class="text-danger">{{ $message }}</small>
                                    @enderror
