    ...
    <section class="section">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">Update Data Ujian Susulan</h4>
            </div>

            <div class="card-body">
                <div class="row">
                    <form action="{{ route('update-ujian-susulan', $ujianSusulan->id) }}" method="post"
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input name="judul" type="text"
                                    ...
                                    value="{{ old('judul', $ujianSusulan->judul) }}">
                                @error('judul')
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="deskripsi" class="form-control @error('deskripsi') is-invalid @enderror" name="" id=""
                                    cols="30" rows="10">{{ old('deskripsi', $ujianSusulan->deskripsi) }}</textarea>
                                @error('deskripsi')
                                    <p><small class="text-danger">{{ $message }}</small>
                                    @enderror
                                </p>
                            ...
                            <div class="form-group">
                                <div class="card shadow-sm p-2 m-0">
                                    @if ($ujianSusulan->img)
                                        <img src="{{ asset('storage/' . $ujianSusulan->img) }}" class="img-responsive"
                            ...
                            <div class="form-group">
                                ...
                                <input name="title_table" type="text"
                                    ...
                                    value="{{ old('title_table', $ujianSusulan->title_table) }}">
                                @error('title_table')
                                    <p><small class="text-danger">{{ $message }}</small>
                                    @enderror
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input name="shift" type="text"
                                    ...
                                    value="{{ old('shift', $ujianSusulan->shift) }}">
                                @error('shift')
                                    <p><small class="text-danger">{{ $message }}</small>
                                    @enderror
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input name="tgl_pendaftaran" type="text"
                                    ...
                                    value="{{ old('tgl_pendaftaran', $ujianSusulan->tgl_pendaftaran) }}">
                            ...
                            <div class="form-group">
                                ...
                                <input name="ruang_pelaksanaan" type="text"
                                    ...
                                    value="{{ old('ruang_pelaksanaan', $ujianSusulan->ruang_pelaksanaan) }}">
                            ...
                            <div class="form-group">
                                ...
                                <input name="tgl_pelaksanaan" type="date"
                                    ...
                                    value="{{ old('tgl_pelaksanaan', $ujianSusulan->tgl_pelaksanaan) }}">
                            ...
                            <div class="form-group">
                                ...
                                <input name="jam_pelaksanaan" type="text"
                                    ...
                                    value="{{ old('jam_pelaksanaan', $ujianSusulan->jam_pelaksanaan) }}">
