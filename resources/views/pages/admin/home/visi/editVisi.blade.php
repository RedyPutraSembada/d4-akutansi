...
@section('content')
    <section class="section">
        <div class="card">
            ...
            <div class="card-body">
                <div class="row">
                    <form action="{{ route('update-visi', $profil->id) }}" method="post">
                        @method('PUT')
                        @csrf
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <textarea name="visi" class="form-control @error('visi') is-invalid @enderror" id="" cols="30"
                                    rows="10">{{ old('visi', $profil->visi) }}</textarea>
                                @error('visi')
                            ...
                            <div class="form-group">
                                ...
                                <input name="judul_hero_vidio" type="text"
                                    ...
                                    value="{{ old('judul_hero_vidio', $profil->judul_hero_vidio) }}">
                            ...
                            <div class="form-group">
                                ...
                                <input name="jmlh_mhs_aktif" type="number"
                                    ...
                                    value="{{ old('jmlh_mhs_aktif', $profil->jmlh_mhs_aktif) }}">
                            ...
                            <div class="form-group">
                                ...
                                <input name="jmlh_reg" type="number"
                                    ...
                                    value="{{ old('jmlh_reg', $profil->jmlh_reg) }}">
                                @error('jmlh_reg')
                                    <p><small class="text-danger">{{ $message }}</small>
                                    @enderror
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input name="link_yt_profil" type="text"
                                    ...
                                    value="{{ old('link_yt_profil', $profil->link_yt_profil) }}">
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="deskripsi" class="form-control @error('deskripsi') is-invalid @enderror" name="" id=""
                                    cols="30" rows="10">{{ old('deskripsi', $profil->deskripsi) }}</textarea>
                                @error('deskripsi')
                                    <p><small class="text-danger">{{ $message }}</small>
                                    @enderror
                                </p>
